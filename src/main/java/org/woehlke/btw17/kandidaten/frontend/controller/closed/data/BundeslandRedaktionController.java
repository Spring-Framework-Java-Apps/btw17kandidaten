...
import org.woehlke.btw17.kandidaten.oodm.db.service.BundeslandService;
...
/**
 * @see org.woehlke.btw17.kandidaten.oodm.db.model.Bundesland
 */
@Controller
@RequestMapping("/redaktion/bundesland")
@SessionAttributes({"suchformular","suchformularFreitext"})
public class BundeslandRedaktionController extends AbstractController {
    ...
    public String all(
        ...
        String pagerUrl = "/redaktion/bundesland/all";
    ...
    @Autowired
    public BundeslandRedaktionController(SessionHandler sessionHandler, BundeslandService bundeslandService, KandidatService kandidatService, KandidatenProperties kandidatenProperties) {
