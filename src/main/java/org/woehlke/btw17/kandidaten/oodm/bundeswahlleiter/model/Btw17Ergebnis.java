...
@Table(
        name = "btw17_ergebnis",
        indexes = {
                @Index(name = "idx_btw17_ergebnis_kandidat_key",columnList = "wahlkreis_nummer"),
                @Index(name = "idx_btw17_ergebnis_titel", columnList = "wahlkreis_name"),
                @Index(name = "idx_btw17_ergebnis_namenszusatz", columnList = "bundesland_nummer")
        }
)
@NamedQueries({
        @NamedQuery(
