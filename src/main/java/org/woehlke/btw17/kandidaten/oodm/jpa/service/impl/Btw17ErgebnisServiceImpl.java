...
import org.woehlke.btw17.kandidaten.oodm.jpa.repositories.Btw17ErgebnisRepository;
import org.woehlke.btw17.kandidaten.oodm.jpa.service.Btw17ErgebnisService;
...
public class Btw17ErgebnisServiceImpl extends JpaDomainServiceImpl<Btw17Ergebnis> implements Btw17ErgebnisService {
    ...
    public List<Btw17Ergebnis> getErgebnisOfBundeslaender() {
        return getRepository().getErgebnisOfBundeslaender();
    }
    ...
    public Page<Btw17Ergebnis> findByBundeslandNummer(long bundeslandNummer, Pageable pageRequest) {
        return getRepository().findByBundeslandNummer(bundeslandNummer,pageRequest);
    }
