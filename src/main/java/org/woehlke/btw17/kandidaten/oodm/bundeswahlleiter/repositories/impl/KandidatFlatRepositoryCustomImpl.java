...
@Repository
public class KandidatFlatRepositoryCustomImpl implements KandidatFlatRepositoryCustom {
    ...
    @Autowired
    public KandidatFlatRepositoryCustomImpl(EntityManager entityManager, DataSource dataSource) {
