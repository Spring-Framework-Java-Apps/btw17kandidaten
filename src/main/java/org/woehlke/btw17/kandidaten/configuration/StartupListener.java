...
public class StartupListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        outputLines.add("--------------------------------------------------------------------------------------------------------------");
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Ergebnis:        "+btw17ErgebnisService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Strukturdaten:   "+btw17StrukturdatenService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Wahlbewerber:    "+btw17WahlbewerberService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Wahlkreis:       "+btw17WahlkreisService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17KandidatFlat:    "+btw17KandidatFlatService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Mdb:             "+btw17MdbService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Wahlperiode:     "+btw17WahlperiodeService.count());
        outputLines.add(" org.woehlke.btw17.kandidaten.oodm.model.Btw17Mdb2Wahlperiode: "+btw17MdbService.countBtw17Mdb2Wahlperiode());
        outputLines.add("--------------------------------------------------------------------------------------------------------------");
