...
public class Btw17ErgebnisImporter {
    ...
    private Btw17Ergebnis csv2object(String csvDataRow) throws Exception {
        ...
        */
        ...
        String x = cells[i];
        i++;
        Long wahlkreisNummer=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        String wahlkreisName=x; x = cells[i]; i++;
        Long bundeslandNummer=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long wahlberechtigteErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long wahlberechtigteErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long wahlberechtigteZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long wahlberechtigteZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long waehlerErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long waehlerErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long waehlerZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long waehlerZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long ungueltigeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long ungueltigeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long ungueltigeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long ungueltigeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gueltigeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gueltigeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gueltigeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gueltigeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long cduErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long cduErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long cduZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long cduZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long spdErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long spdErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long spdZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long spdZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dielinkeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dielinkeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dielinkeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dielinkeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegruenenErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegruenenErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegruenenZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegruenenZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long csuErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long csuErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long csuZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long csuZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long fdpErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long fdpErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long fdpZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long fdpZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long afdErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long afdErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long afdZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long afdZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long piratenparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long piratenparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long piratenparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long piratenparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long npdErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long npdErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long npdZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long npdZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long freieWaehlerErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long freieWaehlerErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long freieWaehlerZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long freieWaehlerZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long oedpErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long oedpErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long oedpZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long oedpZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bayernparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bayernparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bayernparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bayernparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long volksabstimmungErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long volksabstimmungErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long volksabstimmungZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long volksabstimmungZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long pdvErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long pdvErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long pdvZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long pdvZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mlpdErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mlpdErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mlpdZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mlpdZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buesoErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buesoErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buesoZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buesoZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long sgpErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long sgpErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long sgpZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long sgpZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dierechteErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dierechteErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dierechteZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dierechteZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long addErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long addErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long addZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long addZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzallianzErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzallianzErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzallianzZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long tierschutzallianzZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bergparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bergparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bergparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bergparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bgeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bgeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bgeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long bgeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dibErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dibErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dibZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dibZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dkpErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dkpErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dkpZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dkpZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dmErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dmErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dmZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dmZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegrauenErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegrauenErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegrauenZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diegrauenZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long duErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long duErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long duZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long duZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mgErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mgErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mgZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mgZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long menschlicheweltErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long menschlicheweltErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long menschlicheweltZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long menschlicheweltZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diehumanistenErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diehumanistenErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diehumanistenZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diehumanistenZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gesundheitsforschungErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gesundheitsforschungErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gesundheitsforschungZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long gesundheitsforschungZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long vparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long vparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long vparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long vparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buendniscErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buendniscErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buendniscZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long buendniscZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieeinheitErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieeinheitErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieeinheitZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieeinheitZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieviolettenErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieviolettenErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieviolettenZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long dieviolettenZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long familieErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long familieErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long familieZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long familieZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diefrauenErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diefrauenErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diefrauenZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long diefrauenZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mieterparteiErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mieterparteiErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mieterparteiZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long mieterparteiZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long neueliberaleErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long neueliberaleErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long neueliberaleZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long neueliberaleZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long unabhaengigeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long unabhaengigeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long unabhaengigeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long unabhaengigeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long uebrigeErststimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long uebrigeErststimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long uebrigeZweitstimmenVorlaeufig=Long.parseLong(x.compareTo("@")!=0?x:"0"); x = cells[i]; i++;
        Long uebrigeZweitstimmenVorperiode=Long.parseLong(x.compareTo("@")!=0?x:"0");
