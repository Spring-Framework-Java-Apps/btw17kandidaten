...
import org.woehlke.btw17.kandidaten.oodm.db.service.Btw17WahlkreisService;
...
public class Btw17WahlkreisServiceTest {

    private static final Logger log = LoggerFactory.getLogger(Btw17WahlkreisServiceTest.class);
