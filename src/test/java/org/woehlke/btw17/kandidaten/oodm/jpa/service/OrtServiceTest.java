...
public class OrtServiceTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(OrtServiceTest.class);
    ...
    public void test002findByWohnortTest() throws Exception {
        ...
        Assert.assertTrue("Page<Ort> wohnorte : is "+resultSize+"  expected "+resultSizeExpected,resultSize==resultSizeExpected);
        boolean goOn = true;
        while(goOn) {
