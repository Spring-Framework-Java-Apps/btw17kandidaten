...
import org.woehlke.btw17.kandidaten.frontend.controller.open.data.WebseiteAgenturController;
...
public class WebseiteAgenturServiceTest {
    ...
    public void test002findByAgenturTest() throws Exception {
        ...
        Assert.assertTrue("Page<WebseiteAgentur> webseiteAgenturen : is "+resultSize+" expected "+resultSizeExpected,resultSize==resultSizeExpected);
        boolean goOn = true;
        while(goOn) {
