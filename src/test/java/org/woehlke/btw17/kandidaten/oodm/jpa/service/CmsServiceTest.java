...
public class CmsServiceTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(CmsServiceTest.class);
    ...
    public void test002findByCmsTest() throws Exception {
        ...
        Assert.assertTrue("Page<Cms> webseitenCms : is "+resultSize+" expected "+resultSizeExpected,resultSize==resultSizeExpected);
        boolean goOn = true;
        while(goOn) {
