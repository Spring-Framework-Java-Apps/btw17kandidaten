...
public class BerufRedaktionControllerTest {

    private static final Logger log = LoggerFactory.getLogger(BerufRedaktionControllerTest.class);

    @Autowired
    private MockMvc mockMvc;

    @Autowired
    private BerufRedaktionController controller;
    ...
    public void test010getAll() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/redaktion/beruf/all"))
