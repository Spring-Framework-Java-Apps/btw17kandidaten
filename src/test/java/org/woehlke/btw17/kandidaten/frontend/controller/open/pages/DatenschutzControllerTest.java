...
public class DatenschutzControllerTest {

    private static final Logger log = LoggerFactory.getLogger(DatenschutzControllerTest.class);

    @Autowired
    private MockMvc mockMvc;

    @Autowired
    private DatenschutzController controller;
    ...
    public void test010getAll() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/datenschutz"))
                ...
                .andExpect(view().name( "imprint/datenschutz"))
