...
import org.woehlke.btw17.kandidaten.oodm.db.service.FraktionService;
...
public class FraktionRedaktionControllerTest {

    private static final Logger log = LoggerFactory.getLogger(FraktionRedaktionControllerTest.class);

    @Autowired
    private MockMvc mockMvc;

    @Autowired
    private FraktionRedaktionController controller;
    ...
    public void test010getAll() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/redaktion/fraktion/all"))
