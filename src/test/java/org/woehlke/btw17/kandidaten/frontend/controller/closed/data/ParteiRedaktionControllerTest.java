...
public class ParteiRedaktionControllerTest {


    private static final Logger log = LoggerFactory.getLogger(ParteiRedaktionControllerTest.class);

    @Autowired
    private MockMvc mockMvc;

    @Autowired
    private ParteiRedaktionController controller;
    ...
    public void test010getAll() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/redaktion/partei/all"))
