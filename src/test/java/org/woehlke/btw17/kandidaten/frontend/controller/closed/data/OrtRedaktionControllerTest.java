...
import org.woehlke.btw17.kandidaten.oodm.db.service.WohnortService;
...
public class OrtRedaktionControllerTest {

    private static final Logger log = LoggerFactory.getLogger(OrtRedaktionControllerTest.class);
