...
import org.woehlke.btw17.kandidaten.oodm.db.service.MinisteriumService;
...
public class MinisteriumRedaktionControllerTest {


    private static final Logger log = LoggerFactory.getLogger(MinisteriumRedaktionControllerTest.class);

    @Autowired
    private MockMvc mockMvc;

    @Autowired
    private MinisteriumRedaktionController controller;
