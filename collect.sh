...
export DATABASE_URL='jdbc:postgresql://localhost:5432/kandidatencollectdata?user=kandidatencollectdata&password=kandidatencollectdatapwd'
export DATABASE_URL_TEST='jdbc:postgresql://localhost:5432/kandidatencollectdata?user=kandidatencollectdata&password=kandidatencollectdatapwd'
