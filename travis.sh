...
psql -c "CREATE DATABASE kandidatentest WITH OWNER = kandidatentest ENCODING = 'UTF8' LC_COLLATE = 'de_DE.UTF-8' LC_CTYPE = 'de_DE.UTF-8' CONNECTION LIMIT = -1;" -U postgres
